...
const MATERIAIS_LISTA = [
  ...
  { slug: 'ingles-opposites', titulo: 'How English Makes Opposites', descricao: 'The complete system for making opposites in English: suffix -less, prefixes un-, in-/im-/ir-/il-, and dis- — with the three words that will trap you if you apply the logic too confidently.' },
  { slug: 'ingles-word-building', titulo: 'Word Building — Suffixes and Word Families', descricao: 'Four productive suffixes: -ous (noun → adjective), -able/-ible (verb → adjective), -tion/-ment/-ness (verb/adjective → noun), -er/-or/-ist (verb/field → person).' },
