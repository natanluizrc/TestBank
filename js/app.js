...
const MATERIAIS_LISTA = [
  ...
  { slug: 'ingles-word-building', titulo: 'How English Builds New Words', descricao: 'Four productive suffixes: -ous (noun → adjective), -able/-ible (verb → adjective), -tion/-ment/-ness (verb/adjective → noun), -er/-or/-ist (verb/field → person).' },
